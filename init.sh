...
echo -e "  3. Create the ${YELLOW}media-net${NC} Docker network:"
echo -e "     ${YELLOW}docker network create media-net${NC}"
echo -e "  4. Start services: ${YELLOW}cd media-server && docker compose up -d${NC}"
